...
function updateCart(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_1___default().post('/update-cart', pizza).then(function (res) {
...
function initAdmin() {
  ...
  var orders = [];
  var markup;
  axios__WEBPACK_IMPORTED_MODULE_1___default().get('/admin/orders', {
    headers: {
...
function _initStripe() {
  _initStripe = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
    var stripe, card, mountWidget, paymentType, paymentForm, placeOrder;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_4__.loadStripe)('pk_test_51Jc65lSDQ7fAoe2jYxX50KeykgHTznqL9glVgnTmue6KRU99vPkkl1qAqxXJu37qt7xQotbtKiKrGjdw2bIocYZK00KHSLamtf');
          ...
          case 8:
            ...
            if (paymentForm) {
              placeOrder = function placeOrder(formObject) {
